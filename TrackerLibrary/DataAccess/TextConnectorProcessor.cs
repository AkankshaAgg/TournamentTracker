...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            //C:\Users\Aryan\Desktop\Project\TournamentTracker\TournamentTracker\TextFileData\PrizeData.csv
        ...
        public static List<PrizeModel> ConvertToPrizeModels(this List<string> lines)
        {
            ...
            {
                string[] cols = line.Split(','); //every line has data split by commas
        ...
        public static List<TournamentModel> ConvertToTournamentModels(this List<string> lines)
        {
            ...
            ////id^id^id represents one list of matchup model
            //Rounds - List of list of matchup model
